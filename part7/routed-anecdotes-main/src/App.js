...
const Menu = ( { anecdotes, addNew, notification } ) => {
  ...
  return (
    <div>
      ...
      <div>
        <Routes>
          <Route path="/anecdotes/:id" element={<Anedote anecdote={anecdote} />} />
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type='submit'>create</button><button type='button' onClick={() => {content.reset(); author.reset(); info.reset();}}>reset</button>
      </form>
    </div>
  )
